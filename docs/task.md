...
- [ ] 1.专注模式: 专注模式要同时收起:
    ...
    - [ ] 2. F1, 项目详情
    - [ ] 3. F2, 文档列表
- [ ] 2.新建文档: 快捷键需要更换为"N", ctrl+n 在浏览器会变成新建窗口, 且优先级很高
- [ ] 3. 文档最好有唯一 url, 这样方便分享, 任务也是
- [ ] 4. 文档编辑模式, 滚动到最底部会被截断, 最好添加一点点 margin-b 或者 padding-b
