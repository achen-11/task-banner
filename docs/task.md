...
<!-- task-id: 224458ee-f136-4c1f-bc9e-7b8cfa5e6f04 -->
#### 1. 文档保存流程优化

**状态：** 待办
**优先级：** 中
**创建时间：** 2025/11/06 17:57:33
**更新时间：** 2025/11/07 09:42:12

**任务需求：**

现在点击编辑, 会直接进入编辑状态,再点击会发起更新请求, 这是不对的
- [ ] 1. 点击编辑, 进入编辑状态 (同时自动打开专注模式, 收起左侧菜单栏, 左侧文档列表, 收起上方的项目详情)
- [ ] 2. 新增一个 flag, 用来检查内容,标题是否有更新, (isSave 机制)
- [ ] 3. 支持 cmd +s 进行保存
- [ ] 4. 需要有支持更新状态的地方
- [ ] 5. 需要同时展示编辑模式和预览模式
