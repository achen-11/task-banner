<template>
  <div class="h-full flex flex-col">
          ...
          <div class="flex items-center gap-2">
            ...
            <el-tooltip placement="bottom">
              <template #content>
                <div class="flex items-center gap-1.5">
                  <Keyboard :size="14" />
                  <span>{{ focusMode ? `${boardImmersiveCopy.exit} (F1)` : `${boardImmersiveCopy.enter} (F1)` }}</span>
                </div>
              </template>
              <el-button
              ...
              >
                ...
                {{ focusMode ? boardImmersiveCopy.exit : boardImmersiveCopy.enter }}
              </el-button>
            </el-tooltip>
          </div>
        </div>
    ...
    <div
      ...
      :class="scope === 'global' ? (focusMode ? 'h-full min-h-0' : 'min-h-[400px]') : (focusMode ? 'h-full' : 'h-[calc(100%-73px)]')"
    >
      <!-- 加载状态 -->
...
const focusMode = computed(() => parentFocusMode?.value ?? false)
